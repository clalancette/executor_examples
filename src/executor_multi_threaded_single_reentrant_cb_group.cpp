...
class MultiThreadedSingleReentrantCBGroup final : public rclcpp::Node
{
public:
  MultiThreadedSingleReentrantCBGroup()
  : Node("multi_threaded_single_reentrant_cb_group")
  {
    ...
    timer_ = this->create_wall_timer(
      std::chrono::milliseconds(500), std::bind(&MultiThreadedSingleReentrantCBGroup::timer_callback, this), cb_grp_);
  }
...
int main(int argc, char * argv[])
{
  ...
  auto service_caller = std::make_shared<MultiThreadedSingleReentrantCBGroup>();
